...
# Alright - last week, we learned a lot about subsetting, and hopefully the review has cemented the principles
# in your mind. So far, we've used it to retrieve specific portions of objects, mostly so we could check
# certain values. But one of the main uses of subsetting is to change specific values, by combining subsetting
# with assignment.
...
# Let's use the data frame we loaded in exercise 1. Notice that there is no variable named newvar - when
